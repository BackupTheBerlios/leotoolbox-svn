...
%         tic
        [foveatex, peritex]=selectTextures(usemodes(mode), imtex, imblurtex, imgraytex, iminvtex, backtex);
%         toc
%         [foveatex, peritex]=getTextures(w, mode, imdata, imdatablur, imdatagray,backgroundcolor);
%                     [foveaimdata, peripheryimdata]=getImData(mode, imdata, imdatablur, imdatagray, backgroundcolor);
        %             [foveatex, peritex]=getTextures(w, mode, imdata, imdatablur, imdatagray,backgroundcolor);
...
%                     peritex=Screen('MakeTexture', w, peripheryimdata);
...
function [foveatex, peritex]=selectTextures(mode, imtex, imblurtex, imgraytex, iminvtex, backtex)
