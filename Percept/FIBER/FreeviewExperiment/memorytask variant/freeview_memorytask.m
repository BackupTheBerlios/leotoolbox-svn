...
[log_pointer, logfilename] = createlog(LOGPATH,'houses_versus_faces_memorytask');
...
function[ all_events ] =  load_in_events( images, run, used_designmatrix )
   ...
   stimulus_events = add_resting_periods_memorytask(s_events);   
