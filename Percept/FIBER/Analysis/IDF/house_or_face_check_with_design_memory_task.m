function[ trials exportfile ] = house_or_face_check_with_design_memory_task( trials, starting_position, plotting, exporting, designfile )
...
block_design = [1 0 1 0 1 0 1 0 0 0]; % four times stimulus, followed by rest + instructions;
