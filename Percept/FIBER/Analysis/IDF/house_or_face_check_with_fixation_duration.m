function[ trials exportfile ] = house_or_face_check_with_fixation_duration( trials, starting_position, run, plotting, exporting, threshold )
...
if (exporting)
    ...
    % 1 = look at houses / houses watched / short fixation
    % 10 = look at houses / houses watched / long fixation
    
    % 2 = look at houses / faces watched /  sf
    % 11 = look at houses / faces watched / lf
     
    % 3 = look at houses / other watched /  sf
    % 12 = look at houses / other watched / lf

    % 4 = look at faces  /faces watched /  sf
    % 13 = look at faces  /faces watched / lf

    % 5 = look at faces / houses watched /  sf
    % 14 = look at faces / houses watched / lf

    % 6 = look at faces / other watched /  sf
    % 15 = look at faces / other watched / lf
    
    % 7 = free viewing / houses watched /  sf
    % 16 = free viewing / houses watched / lf
    
    % 8 = free viewing / faces watched / sf
    % 17 = free viewing / faces watched /lf
    
    % 9 = free viewing / other watched /  sf
    % 18 = free viewing / other watched / lf
        ...
        for i=1:length(fixations)        
            ...
            if (hit > 0)                
                ...
                %% unneccessary if clause, SIC.               
                    class_copy = class;
                if (fixations(i).duration < FIXATION_THRESHOLD)                    
                    
                    %fprintf('%d\t\t%d\t%d\n', fixations(i).start, fixations(i).duration, fixations(i).end); 
                %% short fixations
                    class = 1 * class;
                else   
                    %% longer fixations
