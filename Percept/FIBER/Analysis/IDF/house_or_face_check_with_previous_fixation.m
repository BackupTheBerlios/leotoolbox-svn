function[ trials exportfile ] = house_or_face_check_with_previous_fixation( trials, starting_position, run, plotting, exporting )
...
if (exporting)
    ...
    % 1 = look at houses / houses watched / house previously watched
    % 10 = look at houses / houses watched / face previously watched
    % 19 = look at houses / houses watched / other previously watched
    
    % 2 = look at houses / faces watched / house previously watched
    % 11 = look at houses / faces watched / face previously watched
    % 20 = look at houses / faces watched / other previously watched
     
    % 3 = look at houses / other watched / house previously watched
    % 12 = look at houses / other watched / face previously watched
    % 21 = look at houses / other watched / other previously watched

    % 4 = look at faces  /faces watched / house previously watched
    % 13 = look at faces  /faces watched / face previously watched
    % 22 = look at faces  /faces watched / other previously watched

    % 5 = look at faces / houses watched / house previously watched
    % 14 = look at faces / houses watched / face previously watched
    % 23 = look at faces / houses watched / other previously watched

    % 6 = look at faces / other watched / house previously watched
    % 15 = look at faces / other watched / house previously watched
    % 24 = look at faces / other watched / other previously watched
    
    % 7 = free viewing / houses watched / house previously watched
    % 16 = free viewing / houses watched / face previously watched
    % 25 = free viewing / houses watched / other previously watched
    
    % 8 = free viewing / faces watched / house previously watched
    % 17 = free viewing / faces watched / face previously watched
    % 26 = free viewing / faces watched / other previously watched
    
    % 9 = free viewing / other watched / house previously watched
    % 18 = free viewing / other watched / face previously watched
    % 27 = free viewing / other watched / other previously watched
        ...
        for i=1:length(fixations)        
            ...
            if (hit > 0)                
                ...
                %% unneccessary if clause, SIC.               
                    class_copy = class;
                if (previous_class == 1)  | (previous_class == 5) | (previous_class == 7)  
                    %% previously houses watched
                    class = 1 * class;
                elseif (previous_class == 2)  | (previous_class == 4) | (previous_class == 8)  
                    %% previously faces watched
                    class = 9 + class;
                elseif (previous_class == 3)  | (previous_class == 6) | (previous_class == 9)  
                    %% previously other watched                    
                    class = class + 18;
                end;   
