function[ ] = present(pictures, window, wRect, log_pointer )
%
%
%  J.B.C. Marsman, 
%
...
for p_i = 1:size(pictures, 2),
 ...
 %     Eyelink('Message', description);
      ...
      if (locations == [0 0])
       ...
       Screen('DrawText',  window, element, locations(1), locations(2), color);   
