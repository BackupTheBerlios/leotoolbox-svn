...
try
    ...
    % initialize video recording here
    ...
    while goOn==1 && event<=nrEvents
        ...
        remoteVideoControl('message', ['Upcoming event: ' par.EVENTTYPE{event}] );
        ...
        while stimPrepReady==0
            ...
            switch( par.EVENTTYPE{event})
                case 'WaitForScanner',
                    ...
                    %                     break
                    %                 end
                    remoteVideoControl('message', ['Wait for scanner'] );
                ...
                case 'Fixation',
                    ...
                    remoteVideoControl('message', ['Fixation'] );
                ...
                case 'Movie',
                    ...
                    remoteVideoControl('message', ['Movie: ' moviename] );
                ...
                case 'Image',
                    ...
                    remoteVideoControl('message', ['Image: ' imgname] );
        ...
        if waitForTrigger==1
            ...
            if firstTriggerTime<0
                ...
                deltaTT=triggerTime-firstTriggerTime;
            end
            remoteVideoControl('message', ['Trigger:' sprintf('%.2f', triggerTime ), 'DeltaTT: ' sprintf('%.2f', deltaTT ) ] );
        ...
        while GetSecs<eventEnd
            ...
            if doFlip==1
                ...
                if stimulusOnsetTime<0
                    ...
                    stimulusOn=1;
                    remoteVideoControl('message', ['Stimulus on:' sprintf('%.2f', vbl-firstTriggerTime ) ] );
                ...
                if stimulusDone==2 && stimulusOnsetTime>0 && actStimDur<0
                    ...
                    stimulusOn=2;
                    remoteVideoControl('message', ['Stimulus off:' sprintf('%.2f', vbl-firstTriggerTime ) ] );
                    remoteVideoControl('message', ['Actual stimulus duration:' sprintf('%.2f', actStimDur ) ] );
                end
    ...
    remoteVideoControl('message', ['End of experiment:' sprintf('%.2f', GetSecs-firstTriggerTime ) ] );
    WaitSecs(2);
    disp('stop recording');
    remoteVideoControl('stoprecording');
    WaitSecs(2);
    disp('shutdown video recorder altogether');
