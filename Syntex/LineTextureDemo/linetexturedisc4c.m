...
%         Screen('FillRect', window, [0 0 0 0]);
       ...
       Screen('FillRect', window, [gray gray gray 0]);
        ...
        % draw central disc
%         Screen('BlendFunction', window, GL_DST_ALPHA, GL_DST_ALPHA);
        Screen('BlendFunction', window, GL_DST_ALPHA, GL_ONE_MINUS_DST_ALPHA);
%         Screen('BlendFunction', window, GL_DST_ALPHA, GL_ONE);
%        Screen('FillRect', window, [gray gray gray]);        
%        Screen('FillRect', window, [gray gray gray 255], maskRect);        
        Screen('DrawLines', window, xymatrix_in, svect, colvect, center, 1);  % change 1 to 0 to draw non anti-aliased lines.
%        Screen('FillRect', window, [255 0 gray], InsetRect(winrect,1,1) );        

        % Draw annulus
     
%         Screen('BlendFunction', window, GL_ONE_MINUS_DST_ALPHA, []);
