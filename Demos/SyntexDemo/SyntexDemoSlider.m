...
try
    ...
    gray=round(GrayIndex(screenNumber));
    ...
    while stop==0
        ...
        %          Screen('Flip', windowPtr [, when] [, dontclear]
        Screen('Flip', w, [], 1);
        ...
        [response, rt, stop]=GetSliderResponse(w);
...
function t=waitForMouseButtonRelease
...
function [r, rt, stop]=GetSliderResponse(window)
...
while 1
    ...
    if omx~=mx | omy~=my
        ...
        dRect = CenterRectOnPoint(rect, mxs, sv);
        Screen('FillOval', window, gray, oldRect );
        Screen('DrawLine', window ,colSlider, minSlider, sv, maxSlider, sv ,3);
        Screen('DrawLine', window ,colSlider, a, sv-lineSlider, a, sv+lineSlider ,3);
        Screen('DrawLine', window ,colSlider, minSlider, sv-lineSlider, minSlider, sv+lineSlider ,3);
        Screen('DrawLine', window ,colSlider, maxSlider, sv-lineSlider, maxSlider, sv+lineSlider ,3);
        Screen('FillOval', window, col, dRect );
