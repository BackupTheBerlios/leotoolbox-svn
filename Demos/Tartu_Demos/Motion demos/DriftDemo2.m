...
%  08/01/07 fwc     added commandwindow, use of GrayIndex, also allow quit on mouseclick
...
if nargin<1
    % Angle of the grating: We default to 45 degrees.
    angle=45;
end;
...
try
    ...
    while(vbl < vblendtime)
        ...
        % uncomment to make grating rotate
%         angle=angle+1;
%         if angle>359.9
%             angle=0;
%         end
        ...
        % Abort demo if any key or mouse button is pressed:
