...
try
    ...
    while 1
        ...
        rect=CenterRectOnPoint(drect, x, y);
        Screen('DrawTexture', w, imtex, [], rect); % draw image
        Screen('DrawTexture', w, masktex, [], rect); % draw and alpha blend with image
        Screen('Flip', w);
        WaitSecs(0.01); % makes sure we don't loose real time control (keep OS happy)
    end
...
% task: make image move to where you click with mouse, make it change size
% or rotate while you move the mouse
