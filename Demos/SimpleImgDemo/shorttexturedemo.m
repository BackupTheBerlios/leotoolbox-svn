...
try
    ...
    if 1 Screen('Preference', 'SkipSyncTests', 1); end % since it's only a demo ...
    AssertOpenGL;
    ...
    elseif 0
        ...
        Screen('DrawTexture',w,imagetex,[],drect);
    else
        Screen('DrawTexture',w,Screen('MakeTexture',w,imread(myimgfile , 'jpg')),[],drect);
    end
